...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
         fieldList.push({type:'string',value:'employeeId',text:'工号',dictCode:''})
         fieldList.push({type:'string',value:'employeeSex',text:'员工性别',dictCode:''})
         fieldList.push({type:'string',value:'employeeDuty',text:'员工职位',dictCode:''})
         fieldList.push({type:'date',value:'employeeBirth',text:'员工生日'})
         fieldList.push({type:'string',value:'employeeName',text:'员工姓名',dictCode:''})
         fieldList.push({type:'string',value:'shangbanTime',text:'上班时间',dictCode:''})
         fieldList.push({type:'string',value:'xiabanTime',text:'下班时间',dictCode:''})
         fieldList.push({type:'string',value:'employeePhoto',text:'员工照片',dictCode:''})
